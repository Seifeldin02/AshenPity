...
const PLAYER_ATTACK_BUFFER_WINDOW := 0.15
const PLAYER_HEAVY_BUFFER_WINDOW := 0.12
...
const PLAYER_DODGE_RECOVERY := 0.055
...
const PLAYER_PARRY_STAGGER := 5.6
const PLAYER_PARRY_DAMAGE := 22.0
const PLAYER_PARRY_KNOCKBACK := 300.0
const PLAYER_PARRY_BRAND_DURATION := 3.0
const PLAYER_PARRY_COLLECT_DAMAGE_MULTIPLIER := 1.22
const PLAYER_PARRY_COLLECT_STAGGER_BONUS := 1.4
const PLAYER_PARRY_COLLECT_KNOCKBACK_BONUS := 90.0
