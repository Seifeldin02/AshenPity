...
func _draw_wall() -> void:
	...
	draw_rect(Rect2(-size * 0.5, size), Color("#27232a"))
	if _wall_texture != null:
		draw_texture_rect(_wall_texture, rect, true, Color(0.62, 0.58, 0.62, 0.88))
	else:
...
func _draw_broken_wall() -> void:
	...
	if _brick_texture != null:
		draw_texture_rect(_brick_texture, left, true, Color(0.64, 0.58, 0.60, 0.92))
		draw_texture_rect(_brick_texture, right, true, Color(0.50, 0.46, 0.50, 0.92))
	else:
